...
\begin{document}
    ...
    \input{report/chapters/analisi.tex}% https://guides.library.bloomu.edu/litreview
    \input{report/chapters/architectures.tex}
    \input{report/chapters/implementazione.tex}
    \input{report/chapters/interazioni.tex}
    \input{report/chapters/DevOps.tex}
    \input{report/chapters/validazione.tex}
