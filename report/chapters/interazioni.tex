...
Un grande vantaggio dell'uso delle WebSocket stà nella facile implementazione delle chat. Questo sistema richiedeva l'impiego di 2 diverse chat per permettere la comunicazione tra utenti sia globalmente che all'interno di una singola partita. 
Anche in questo caso, il middleware si occupa di instradare i messaggi alle giuste chat, in modo da garantire la privacy delle conversazioni. Il frontend, invece, si occupa di visualizzare i messaggi e di inviarli al middleware.

La gestione della persistenza delle chat è stata implementata tramite l'uso del session storage del browser. Questo permette di mantenere la chat anche in caso di refresh della pagina.
